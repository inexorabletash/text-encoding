...
test(
  ...
  function () {
    ...
    encodings.forEach(function (encoding) {
      var ascii_string = (function() {
        ...
        for (var i = 0; i < 128; ++i) {
          ...
          if (encoding === "iso-2022-jp" && i === 0x1B)
            continue;
          if (encoding === "iso-2022-kr" && (i === 0x0E || i === 0x0F))
            continue;
      ...
      var ascii_encoded = TextEncoder('ascii').encode(ascii_string);
      equal(TextDecoder(encoding).decode(ascii_encoded), ascii_string, encoding);
    });
  });
