...
(function(global) {
  ...
  /**
   * @param {Array.<number>} Array of code points.
   ...
   *
   * @constructor
   * @param {Array.<number>} tokens Array of tokens that provide the
   * stream.
   */
  ...
  TextDecoder.prototype = {
    ...
    decode: function decode(opt_view, options) {
      if (typeof opt_view === 'object' &&
          !('buffer' in opt_view && 'byteOffset' in opt_view && 'byteLength' in opt_view)) {
