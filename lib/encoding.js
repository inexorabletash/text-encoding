...
(function(global) {
  ...
  Encoder.prototype = {
     ...
     */
    encode: function(stream, code_point) {}
  };
  ...
  TextEncoder.prototype = {
    ...
    encode: function encode(opt_string, options) {
      ...
      var result;
      while (!input_stream.endOfStream()) {
        result = this._encoder.encode(input_stream, input_stream.read());
        if (result === finished)
          break;
  ...
  function UTF8Encoder(options) {
     ...
     */
    this.encode = function(stream, code_point) {
      /** @type {number} */
  ...
  function ISO2022JPEncoder(options) {
    ...
    this.encode = function(stream, code_point) {
      ...
      if (inRange(code_point, 0xFF61, 0xFF9F) &&
        ...
        stream.prepend(code_point);
        iso2022jp_state = state.Katakana;
        return [0x1B, 0x28, 0x49];
      }
      if (inRange(code_point, 0xFF61, 0xFF9F))
        return code_point - 0xFF61 - 0x21;
  ...
  function UTF16Encoder(utf16_be, options) {
    ...
    this.encode = function(stream, code_point) {
      ...
      return convert_to_bytes(lead).concat(convert_to_bytes(trail));
    };
  }
